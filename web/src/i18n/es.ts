...
export const es: typeof en = {
  ...
  usageInfo: {
    ...
    blue: 'Azul — por debajo de 0,7× de lo esperado: consumo muy inferior al ritmo previsto.',
    green: 'Verde — de 0,7× a 1,0×: ritmo sostenible para llegar al reset sin agotar el límite.',
    gradient: 'Por encima de 1,0× y por debajo de 1,5× — pasa del verde por el amarillo hasta acercarse al rojo; amarillo en 1,25×.',
    red: 'Rojo — de 1,5× a 2,0×: consumo rápido, con riesgo de agotar el límite antes del reset.',
    purple: 'Morado — por encima de 2,0×: consumo muy superior al ritmo esperado (overusage).',
    unknown: 'Gris — sin cálculo de ritmo para esta barra; muestra solo el % consumido.',
    tip: 'El multiplicador junto al título muestra el ritmo: 1,5× significa un consumo un 50% superior al esperado para el tiempo transcurrido.',
  },
  externalLink: {
  ...
  chat: {
    ...
    fileMentionTitle: 'Referenciar archivo',
    fileMentionSearch: 'Buscar en esta carpeta…',
    fileMentionClear: 'Limpiar búsqueda',
    fileMentionBack: 'Volver a la carpeta anterior',
    fileMentionRoot: 'Ir a la raíz del proyecto',
    fileMentionLocation: 'Carpeta actual',
    fileMentionFolder: 'Carpeta',
    fileMentionFile: 'Archivo',
    fileMentionLoading: 'Cargando archivos…',
    fileMentionEmpty: 'Esta carpeta está vacía.',
    fileMentionNoMatch: 'Ningún archivo o carpeta con ese nombre.',
    fileMentionError: 'No se pudo listar esta carpeta. Inténtalo de nuevo.',
    fileMentionDenied: 'No tienes acceso a esta carpeta.',
    fileMentionMissing: 'Esta carpeta ya no está disponible. Vuelve a la carpeta anterior.',
    fileMentionRetry: 'Reintentar',
    fileMentionMore: 'Cargar más',
    fileMentionHint: 'Abre carpetas para navegar. Elige un archivo para referenciarlo en tu mensaje.',
    ...
    compacting: 'Compactando el contexto…', compactingElapsed: 'resumiendo la conversación · {{s}}s',
  ...
  controls: {
    ...
    autoCompact: 'Auto-compactar al', autoCompactOff: 'apagado', autoCompactHint: 'al terminar el turno, compacta sesiones Claude y Codex por encima de este porcentaje (global). Apagado conserva la compactación nativa de cada agente.',
  },
  slash: {
  ...
  usage: {
    claude: 'Claude', plans: 'Planes', weekly: 'semanal', tokens: 'tokens', tokensToday: '{{n}} hoy', tokensTip: 'Tokens reportados en las sesiones de Claudinei. Las barras muestran los límites de toda la cuenta.', tokenBreakdown: '{{in}} entrada · {{out}} salida · {{reasoning}} razonamiento',
