...
// Token do ícone do Claude: mesma mecânica do Codex — o backend (claude-engine.ts)
// manda a string e o frontend desenha o logomark oficial como SVG JSX.
export const CLAUDE_ICON = 'claude'

/**
 * Logomark oficial do Claude, monocromático (herda currentColor), 1em.
 * Fica sem a cor de marca (#D97757) de propósito: o ícone aparece em aba ativa,
 * inativa, badge do card e hover — herdar a cor do contexto mantém a legibilidade
 * em todos, e o Codex ao lado também é monocromático.
 */
function ClaudeLogo() {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" width="1em" height="1em" aria-hidden="true" focusable="false">
...
const LOGO_TOKENS: Record<string, () => JSX.Element> = {
  [OPENAI_ICON]: OpenAILogo,
  [CLAUDE_ICON]: ClaudeLogo,
}
